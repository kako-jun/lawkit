...
mod benford_distribution_tests {
    ...
    fn test_chi_square_calculation() {
        ...
        let observed = BENFORD_EXPECTED_PERCENTAGES.clone();
        let expected = BENFORD_EXPECTED_PERCENTAGES.clone();
        let (chi_square, _) = calculate_chi_square(&observed, &expected);
    ...
    fn test_chi_square_with_deviation() {
        ...
        let expected = BENFORD_EXPECTED_PERCENTAGES.clone();
        let (chi_square, p_value) = calculate_chi_square(&observed, &expected);
