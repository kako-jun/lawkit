...
mod risk_level_tests {
    ...
    fn test_risk_level_consistency() {
        ...
        let mut previous_risk_numeric = 0;
...
mod confidence_score_tests {
    ...
    fn test_confidence_score_bounds() {
        ...
        for (sample_size, p_value, mad) in test_cases {
...
mod integrated_risk_assessment_tests {
    ...
    fn test_borderline_risk_assessment() {
        ...
        let borderline_cases = vec![
            (0.100, RiskLevel::Medium), // Exactly at boundary
            (0.050, RiskLevel::High),   // Exactly at boundary
            (0.010, RiskLevel::Critical), // Exactly at boundary
        ];
        
        for (p_value, expected_risk) in borderline_cases {
            let result = create_test_result(
                "borderline_test",
                100,
