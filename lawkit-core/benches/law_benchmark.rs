...
fn bench_benford_analysis(c: &mut Criterion) {
    let test_data = vec![
        ...
        901.23, 112.34, 223.45, 334.56, 445.67, 556.78, 667.89, 778.90,
        889.01, 990.12, 101.23, 212.34, 323.45, 434.56, 545.67, 656.78,
        767.89, 878.90, 989.01, 190.12, 281.23, 372.34, 463.45, 554.56,
    ];
...
fn bench_pareto_analysis(c: &mut Criterion) {
    let test_data = vec![
        100.0, 200.0, 150.0, 300.0, 250.0, 400.0, 350.0, 500.0,
        450.0, 600.0, 550.0, 700.0, 650.0, 800.0, 750.0, 900.0,
        850.0, 1000.0, 950.0, 1100.0, 1050.0, 1200.0, 1150.0, 1300.0,
        1250.0, 1400.0, 1350.0, 1500.0, 1450.0, 1600.0, 1550.0, 1700.0,
    ];
...
fn bench_zipf_analysis(c: &mut Criterion) {
    let test_data = vec![
        1000.0, 500.0, 333.0, 250.0, 200.0, 166.0, 142.0, 125.0,
        111.0, 100.0, 90.0, 83.0, 76.0, 71.0, 66.0, 62.0,
        58.0, 55.0, 52.0, 50.0, 47.0, 45.0, 43.0, 41.0,
        40.0, 38.0, 37.0, 35.0, 34.0, 33.0, 32.0, 31.0,
    ];
...
fn bench_normal_analysis(c: &mut Criterion) {
    let test_data = vec![
        10.0, 12.0, 11.0, 13.0, 9.0, 14.0, 8.0, 15.0,
        7.0, 16.0, 6.0, 17.0, 5.0, 18.0, 4.0, 19.0,
        3.0, 20.0, 2.0, 21.0, 1.0, 22.0, 0.0, 23.0,
        11.5, 12.5, 10.5, 13.5, 9.5, 14.5, 8.5, 15.5,
    ];
...
fn bench_poisson_analysis(c: &mut Criterion) {
    let test_data = vec![
        ...
        0.0, 3.0, 1.0, 4.0, 2.0, 5.0, 3.0, 1.0,
        0.0, 2.0, 4.0, 3.0, 1.0, 5.0, 2.0, 0.0,
        3.0, 1.0, 4.0, 2.0, 5.0, 0.0, 3.0, 1.0,
    ];
