...
fn output_integration_result(
    ...
    result: &crate::laws::integration::IntegrationResult,
    config: &OutputConfig,
) -> Result<()> {
...
fn output_conflict_analysis_result(
    writer: &mut Box<dyn Write>,
    result: &crate::laws::integration::ConflictAnalysisResult,
    config: &OutputConfig,
) -> Result<()> {
    let lang = &config.language;
...
fn output_cross_validation_result(
    writer: &mut Box<dyn Write>,
    result: &crate::laws::integration::CrossValidationResult,
    config: &OutputConfig,
) -> Result<()> {
    let lang = &config.language;
...
fn output_recommendation_result(
    writer: &mut Box<dyn Write>,
    result: &crate::laws::integration::DetailedRecommendationResult,
    config: &OutputConfig,
) -> Result<()> {
    let lang = &config.language;
